...
/* ---- inline block ---- */
      ...
      (function () {
        ...
        // (Out-of-stock is handled natively in single.twig: when the product
        // isn't 'sale' the twig renders <salla-add-product-button> with the
        // right product-status, so there's no #mp-add here to swap.)
